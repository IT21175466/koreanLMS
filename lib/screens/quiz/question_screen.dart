...
class _QuestionScreenState extends State<QuestionScreen> {
  ...
  void initState() {
    ...
    quizProvider.loading = true;
    quizProvider.getQuizzes(
        widget.quizName, widget.batchName, widget.classID, widget.termID);
    super.initState();
  }
              ...
              : Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        height:
                            screenHeight - (AppBar().preferredSize.height * 2),
                        width: screenWidth,
                          ...
                          child: Column(
                            children: [
                              SingleQuestion(
                                ...
                                questionVideo: quizProvider
                                    .quizzes[index].questionVideoLink,
                                questionImage:
                                ...
                                answer1Video: quizProvider
                                    .quizzes[index].answer1VideoLink,
                                answer2Video: quizProvider
                                    .quizzes[index].answer2VideoLink,
                                answer3Video: quizProvider
                                    .quizzes[index].answer3VideoLink,
                                answer4Video: quizProvider
                                    .quizzes[index].answer4VideoLink,
                                answer5Video: quizProvider
                                    .quizzes[index].answer5VideoLink,
                                correctAnswer:
                                    quizProvider.quizzes[index].correctAnswer,
                                timer: quizProvider.quizzes[index].timer,
                                indexOfQuiz: index,
                                paperTimer: widget.paperTimer,
                              ),
                              Row(
                                children: [
                                  quizProvider.quizzes[index].isBackEnable
